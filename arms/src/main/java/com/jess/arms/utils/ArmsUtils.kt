...
import com.jess.arms.utils.ArmsUtils.Companion.getResources
...
class ArmsUtils private constructor() {
    ...
    companion object {
        ...
        fun snackbarText(text: String) {
            AppManager.appManager!!.showSnackbar(text, false)
        }
        ...
        fun snackbarTextWithLong(text: String) {
            AppManager.appManager!!.showSnackbar(text, true)
        }
        ...
        fun startActivity(activityClass: Class<*>) {
            AppManager.appManager!!.startActivity(activityClass)
        }
        ...
        fun startActivity(content: Intent) {
            AppManager.appManager!!.startActivity(content)
        }
