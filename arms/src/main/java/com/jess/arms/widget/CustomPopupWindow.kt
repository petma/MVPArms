...
class CustomPopupWindow private constructor(builder: Builder) : PopupWindow() {
    ...
    class Builder private constructor() {
        ...
        private var listener: CustomPopupWindowListener? = null
        private var isOutsideTouch = true//默认为true
        private var isFocus = true//默认为true
        private var backgroundDrawable: Drawable = ColorDrawable(0x00000000)//默认为透明
