...
class AppDelegate(context: Context) : App, AppLifecycles {
     ...
     */
    private class AppComponentCallbacks internal constructor(private val mApplication: Application, private val mAppComponent: AppComponent) : ComponentCallbacks2 {
